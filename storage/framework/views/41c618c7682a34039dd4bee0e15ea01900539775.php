...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Franchise'); ?>
    ...
    <style>
        ...
        .bg.fix.layer{
            background-image: url(<?php echo e(asset('images/4.jpg')); ?>);
        }
        @media  only screen and (max-width:768px){
            .bg.fix.layer{
                background: url(<?php echo e(asset('images/4.jpg')); ?>) fixed no-repeat center;
            }
        }
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 px-lg-5 px-md-3">
                        <div class="left-side">
                            <img src="<?php echo e(asset('images/3.jpg')); ?>" alt="" class="img-fluid">
                            <p class="" >Read about our franchise opportunities <br><a
                                    href="<?php echo e(asset('images/broucher.pdf')); ?>"  target="_blank"
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 px-lg-5 px-md-3">
                        ...
                        <form action="<?php echo e(route('franchise')); ?>" method="post" id="franchiseForm"
...
<?php endif; ?>
<?php /**PATH /media/abdulwahid/DATA/Study-Material/Salva_Fast_Food/resources/views/franchise.blade.php ENDPATH**/ ?>