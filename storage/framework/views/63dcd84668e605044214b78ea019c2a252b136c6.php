...
<nav>
    ...
    <a href="/" class="nav-logo"><img src=" <?php echo e(($logo->file) ? asset('logo_images/').'/'.$logo->file : asset('images/logo.png')); ?>" alt=""></a>
...
<?php /**PATH D:\work\works OutSource\Salva_Fast_Food\resources\views/layouts/header.blade.php ENDPATH**/ ?>