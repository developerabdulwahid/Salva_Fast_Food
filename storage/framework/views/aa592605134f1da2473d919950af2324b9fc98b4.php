...
<?php $component->withAttributes([]); ?>
  <?php $__env->startSection('title', 'Our Stories'); ?>
  <style>
    .story {
      display: flex;
    }
    ...
    .story .description {
      background: url('<?php echo e(asset('images/BACKGROUND.jpg')); ?>') no-repeat center;
  ...
  <section class="section banner">
    ...
    <div class="content-wrap p-0">
      ...
      <div class="story">
        ...
        <img src="<?php echo e(asset('images/about-banner.jpg')); ?>" alt="" class="img-fluid">
      </div>
      <div class="story opposite">
        <img src="<?php echo e(asset('images/ourstory-2.jpg')); ?>" alt="" class="img-fluid">
        <div class="description">
...
<?php endif; ?>
<?php /**PATH /home/u318926794/domains/salvafastfood.co.uk/public_html/resources/views/story.blade.php ENDPATH**/ ?>