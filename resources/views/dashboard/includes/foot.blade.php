  ...
  <script src="{{asset('dashboard')}}/assets/bundles/jquery-selectric/jquery.selectric.min.js"></script>
  <script src="{{asset('dashboard')}}/assets/bundles/upload-preview/assets/js/jquery.uploadPreview.min.js"></script>
  <script src="{{asset('dashboard')}}/assets/bundles/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
</body>
