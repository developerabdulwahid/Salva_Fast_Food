<x-app-layout>
  ...
  <style>
    ...
    .rewards .opacity {
      ...
      width: 100%;
      opacity: .15;
       /*background: url('{{ asset("images/4.jpg")}}') no-repeat center; */
            ...
            <div id="carouselExampleCaptions" class="carousel slide carousel-fade"   data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="{{asset('images/image_2.png' ) }}" id="sliderimg" class="carousel-image d-block w-100" alt="...">
                        <div class="carousel-caption">
                            <img src="{{asset('images/slogan.png' ) }}"/>
                    ...
                    <div class="carousel-item">
                        <img src="{{asset('images/image_3.png' ) }}" id="sliderimg" class="carousel-image d-block w-100" alt="...">
                        <div class="carousel-caption">
                            <img src="{{asset('images/slogan.png' ) }}"/>
                    ...
                    <div class="carousel-item">
                        <img src="{{asset('images/image_7.png' ) }}" id="sliderimg" class="carousel-image d-block w-100" alt="...">
                        <div class="carousel-caption">
                            <img src="{{asset('images/slogan.png' ) }}"/>
