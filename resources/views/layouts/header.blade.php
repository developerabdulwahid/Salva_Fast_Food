...
<nav>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item">
        <a href="{{route('menu')}}" class="{{ request()->is('menu') ? 'active' : '' }} nav-link">Menu</a>
      </li>
      <li class="nav-item">
        <a href="{{route('franchise')}}" class="{{ request()->is('franchise') ? 'active' : '' }} nav-link">Franchise</a>
      </li>
      <li class="nav-item">
        <a href="{{route('career')}}" class="{{ request()->is('career') ? 'active' : '' }} nav-link">Career</a>
      </li>
      ...
      <li class="nav-item">
        <a href="{{route('contact')}}" class="{{ request()->is('contact') ? 'active' : '' }} nav-link">Contact Us</a>
      </li>
